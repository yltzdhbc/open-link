...
/*
    ...
    sector4   0x0801 0000 - 0x0801 FFFF   64K      |
    sector5   0x0802 0000 - 0x0803 FFFF   128K     app
    sector6   0x0804 0000 - 0x0805 FFFF   128K     |
    sector7   0x0806 0000 - 0x0807 FFFF   128K     |
    sector8   0x0808 0000 - 0x0809 FFFF   128K     |
    sector9   0x080A 0000 - 0x080B FFFF   128K     |
    ...
    sector10  0x080C 0000 - 0x080D FFFF   128K     params
    sector11  0x080E 0000 - 0x080F FFFF   128K     |
*/

#define FMC_PAGE_SIZE ((uint16_t)(0x100U)) // GD32F4 页大小 4k
#define FMC_WRITE_START_ADDR ((uint16_t)(0x080C0000U))
#define FMC_WRITE_END_ADDR ((uint16_t)(0x080DFFFFU))
